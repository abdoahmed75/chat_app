...
class acceptProvider extends StatefulWidget {
  final String? authToken;
  final int?id;
  const acceptProvider({Key? key, this.authToken, this.id}) : super(key: key);

  @override
  _acceptProviderState createState() => _acceptProviderState();
}

class _acceptProviderState extends State<acceptProvider> {
  ...
  Future<List> fetchLostData() async {
    var response = await http.post(
      Uri.parse('https://project-graduation.000webhostapp.com/api/helper/get-acceptance-to-support-to-be-done')  ,
      headers: {
        "authToken":token!,
      },
      body:
