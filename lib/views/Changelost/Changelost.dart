...
class Changelost extends StatefulWidget {
  final int?id;
  const Changelost({Key? key, this.id}) : super(key: key);
  @override
  State<Changelost> createState() => _ChangelostState();
}
class _ChangelostState extends State<Changelost> {
  ...
  String user_url='https://project-graduation.000webhostapp.com/api/needer/get-one-lost';
  ...
  {
    await http.post(
        Uri.parse('https://project-graduation.000webhostapp.com/api/needer/delete-lost'),
        headers: {
          "authToken": token!,
        },
        body: <String,String>
  ...
  Future <http.StreamedResponse>? UpdateLostW (Map<String,dynamic>data )async{
    ...
    try {
      print(data);
      var request=http.MultipartRequest("POST",Uri.parse('https://project-graduation.000webhostapp.com/api/needer/update-lost') );
        ...
        body: FutureBuilder(
          ...
          builder: (context,AsyncSnapshot <Map <String ,dynamic>? >snapshot) {
            if(!snapshot.hasData) return Center(child: CircularProgressIndicator());
              ...
              date_c.text=snapshot.data!["expected_lost_date"];
              position_c.text=snapshot.data!["expected_lost_place"];
