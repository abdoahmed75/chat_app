...
class acceptDeliver extends StatefulWidget {
  final String? authToken;
  final int?id;
  const acceptDeliver({Key? key, this.authToken, this.id}) : super(key: key);

  @override
  _acceptDeliverState createState() => _acceptDeliverState();
}

class _acceptDeliverState extends State<acceptDeliver> {
  ...
  Future<List> fetchLostData() async {
    var response = await http.post(
      Uri.parse('https://project-graduation.000webhostapp.com/api/needer/get-acceptance-for-thing-to-be-done')  ,
      headers: {
        "authToken":token!,
      },
      body:
