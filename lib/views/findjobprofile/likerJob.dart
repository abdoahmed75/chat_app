...
class likerJob extends StatefulWidget {
  final String? authToken;
  final int?id;
  const likerJob({Key? key, this.authToken, this.id}) : super(key: key);

  @override
  _likerJobState createState() => _likerJobState();
}

class _likerJobState extends State<likerJob> {
  ...
  Future<List> fetchLostData() async {
    var response = await http.post(
      Uri.parse('https://project-graduation.000webhostapp.com/api/needer/get-matches-for-need-job') ,
      headers: {
        "authToken":token!,
      },
      body:
